    ...
    <div className="min-h-screen bg-gray-900 text-white p-6">
      <header className="flex justify-between items-center pb-6 border-b border-gray-800">
        <div>
          ...
          <p className="text-sm text-gray-400">Orchestrated Autonomous Pipeline</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
        <div className="bg-gray-800 p-6 rounded-xl border border-gray-700 h-fit">
          ...
          <form onSubmit={handleCreateLead} className="space-y-3">
            ...
            />
            <textarea
              placeholder="Notes / AI Context (e.g. Budget, Urgency, Demo request)"
              value={newLead.notes}
            ...
            >
              {submitting ? 'Analyzing & Scoring...' : 'Add Lead'}
            </button>
          </form>
        </div>
              ...
              <table className="w-full text-left text-sm">
                <thead className="bg-gray-700 text-gray-300">
                  <tr>
                    ...
                    <th className="p-3">AI Score & Reasoning</th>
                  ...
                  {leads.map((lead) => (
                    <tr key={lead._id}>
                      <td className="p-3 align-top">
                        ...
                        {lead.company && <div className="text-xs text-blue-300 mt-1">{lead.company}</div>}
                      </td>
                      <td className="p-3 align-top">
